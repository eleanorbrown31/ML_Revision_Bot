...
| Boosting (AdaBoost, Gradient Boosting, XGBoost) | Sequential learning · weighted samples · AdaBoost algorithm · gradient boosting intuition · XGBoost regularisation · learning rate in boosting |
